    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add New Product In Stock</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Material Name" wire:model="name" wire:keyup="generateslug">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sliug" name="slug" placeholder="Material Slug" wire:model="slug">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="badge_number" name="badge_number" placeholder="badge number" wire:model="badge_number">
                                        @error('badge_number')<p class="text-danger">{{$message}}</p>@enderror
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="production_cost">Product Cost</label>
                                        <input type="text" class="form-control" id="production_cost" name="production_cost" placeholder="0.0" wire:model="production_cost">
                                        @error('production_cost')<p class="text-danger">{{$message}}</p>@enderror
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="weight" name="weight" placeholder="0.0" wire:model="weight">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="quantity" name="quantity" placeholder="0.0" wire:model="quantity">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="expiry_date" name="expiry_date" placeholder="Material Expiry Date" wire:model="expiry_date">

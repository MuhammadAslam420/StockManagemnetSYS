...
<html lang="en">
    ...
    <body>
        ...
        <table class="table table-stripped mt-3">
            <thead>
                <tr>
                    @if($invoice->status)
                    <p class="text-uppercase cool-gray">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="px-0">
                        <h1 class="border-0 pl-0 party-header">
    ...
    <p>
        {{ trans('invoices::invoice.pay_until') }}: {{ $order->payment_due_date}}
    </p>
    <p>
        {{ trans('Signature') }}:_______________________________________________
    </p>
